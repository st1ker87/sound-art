...
class SinglePersonSeeder6 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_town		= 'Sydney NSW, Australia';
		$work_address 	= '91 Illawarra Rd, Marrickville NSW 2204';
		...
		// * About me
		$bio_text1 = 
			"Providing gorgeous Nylon string guitar parts for any genre. Classical, Jazz Pop contemporary. I also write music and providing songwriting/composition services to suit any project small or large.

			Hello!
			
			Hi there, my name is Gavin Libotte ,and I am a professional Guitarist/Composer.
			I have been specializing in Nylon string guitar pick style and fingerstyle for over 30 years.
			I have 6 Albums available to listen to on Spotify and all digital platforms and have played all over the world.
			I can play Spanish/Latin guitar solos, or fingerpicking parts on any song. I also play jazz and classical pop and many other styles.
			You can also send me your song, concept or idea and I’ll come up with an arrangement, solo or those lines or chords that you are looking for.
			I also read music, so you can send me the music score or an audio file, and I will play it note per note. I will send you audio tracks in WAV format 44.1kHz with/out my effects on.
			
			Please don't hesitate to contact me to discuss your project in details.
			
			I have played / worked with Buena Vista Social Club, Cassandra Wilson, Jospeh Tawadros, Jonathan Zwartz, and many others.";
		...
		$bio_text4 = "Providing gorgeous Nylon string guitar parts for any genre.";
		 ...
		 */
		 ...
		 $image_name = 'Gavin_website_pic_NEW.jpg';
		...
		$categories = ['Guitarist','Composer']; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['Classical','Folk','Jazz','Latin'];  

		// % OFFERS % 

		$offers = ['collaboration','recording','arrangement']; // ! obbligatorio !
