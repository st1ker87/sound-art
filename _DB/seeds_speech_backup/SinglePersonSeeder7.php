...
class SinglePersonSeeder7 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_town		= 'Abu Dhabi, United Arab Emirates';
		$work_address 	= 'Sheikh Rashid Bin Saeed St, Al ManhalW14-02';
		$phone 			= '+971 2 566 6452';
		...
		$bio_text1 = 
			...
			I am a full time musician. Creating beautiful cello sound is what I do best. If you'd like to know more about my work and playing style, feel free to visit my YouTube channel, just search using the keyword \"Vesislava\" and you'll find it! Quality speaks for itself!
		...
		$categories = ['cellist','youtuber']; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['Chill','Classical','Folk','Pop','Pop-Rock'];  
