...
class SinglePersonSeeder60 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_town		= 'Zielona Gora, Poland';
		$work_address 	= 'Jedności 4, 65-018 Zielona Góra';
		$phone 			= '+48 53 513 1243';
		...
		// * About me
		$bio_text1 = 
			"Hi there, Thanks for checking my page! Music production has been my full time job since 2007. Since then I have worked as a producer, remixer, mastering engineer and ghost producer for various artists and labels. You can find my tracks on Anjunadeep, Armada, Connaisseur, Proton or Silk to name just a few.

			I have also produced music for commercial adverts (for banking products for example), TV shows and special applications (jingles, alerts, etc). I have released multiple commercially successful sample packs which I have produced from scratch.
			
			I have been working as a ghost producer for a number of popular and very successful artists. They either supplied parts or a song idea - I have produced for them completely new track or a remix.
			
			I have been working remotely with clients who are not musicians themselves and used words as well as music examples (youtube or spotify) to define the melody they had in mind. On all occasions I was able to deliver the song they were very happy with (and came back for more).
			
			Does above sound like someone who can help you with your musical idea? If so then please do get in touch!
		...
		$bio_text4 = "Producer, remixer, mastering engineer and ghost producer";
		...
		$genres = ['Chill','EDM','Electronic','House','Soundtrack','Techno','Trance'];  
