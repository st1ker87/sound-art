...
class SinglePersonSeeder8 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_town		= 'London, UK';
		$work_address 	= '224 Trafalgar Rd, London SE10 9ER';
		...
		// * About me
		$bio_text1 = 
			"I am a dedicated session cellist who would love to add layers of rich cello sound to your track. Last year I toured extensively with producer Giorgio Moroder. I have a variety of recording experience, from traditionally classical, to pop, disco, afrobeat & folk. I can improvise and write parts for your songs and I'll find the sound right for you.

			I love to record from home and to find the sound and style to best suit your song. I ensure every recording is the best quality it can be, and if you need anything played differently, or details added, I will ensure to do revisions for you.
			
			I can offer improvised ideas for your track before recording, if you don't have a string arrangement already.
			Or send me a score and the track and I can record straight away!
			
			Simply send me the MP3 and the BPM.
			
			I will be recording with Aston stereo microphones plus a Condenser Aston Origin microphone. I can give you a separate track on these if you'd like, no problem!
			
			I have recorded for many TV/Film catalogues and I recorded the music for David Attenborough's series Dynasties.
			
			Last year I also had the privilege to work with Trevor Horn, Beverley Knight and Pete Tong, but to name a few.
			I also recorded recently on Roger O'Donnell's (The Cure) new upcoming album.
			
			I have recorded for Dua Lipa, JHus, and appeared live on BBC1 Live Lounge with Yungblud, and BB1 with The Vamps and on Femi Temowo's Afrobeat album 'Music is the Feeling.'
			
			I have a diverse musical background, having been a member of several bands. However I trained Classically on Cello for 6 years at Conservatoires, obtaining a Masters in Music Performance from Trinity Laban Conservatoire of Music and Dance, London in 2013.
		...
		$categories = ['cellist','Songwriter']; // ! obbligatorio ! 
