...
class SinglePersonSeeder58 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_address 	= '2201 W Rosecrans Ave, Gardena, CA 90249';
		$phone 			= '+1 31 0324 3444';
		...
		$bio_text1 = 
			...
			*All co-writes I retain my publishing rights via Warner Chappell, the % varies depending on the project*
			...
			1 FREE minor Revision is provided. *see terms* No Refunds.
		...
		$bio_text4 = "Professional Songwriter/Vocalist";
		 ...
		 */
		 ...
		 $image_name = '0A6888E1-EE70-4C27-9D8A-785102240939.jpg';
		...
		$genres = ['EDM','Electronic','Hip Hop','House','Pop','Pop Rock'];  

		// % OFFERS % 

		$offers = ['recording','teaching','live exhibition','writing']; // ! obbligatorio !
