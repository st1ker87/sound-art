...
class SinglePersonSeeder43 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		// * About me
		$bio_text1 = 
			"GUITARS FOR YOUR SONG OR BEAT. HQ. MULTIPLE STYLES

			Guitarist with 10 years of experience on stages and projects, both my own and participating as a session player. Styles: Funk, disco, hip-hop, jazz, neo-soul, trap, rock, metal, blues.
		...
		$bio_text4 = "Guitarist with 10 years of experience on stages and projects";
		 ...
		 */
		 ...
		 $image_name = 'IMG_3892057178BF-1.jpg';
		...
		$genres = ['Heavy Rock','Hip Hop','Jazz','Pop','R&B','Soul','Rock','Trap'];  
