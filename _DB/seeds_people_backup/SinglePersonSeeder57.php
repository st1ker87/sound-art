...
class SinglePersonSeeder57 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_town		= 'Detroit, MI, USA';
		$work_address 	= '9321 Rosa Parks Blvd, Detroit, MI 48206';
		$phone 			= '+1 31 3307 5518';
		...
		// * About me
		$bio_text1 = 
			"Former signed freelance bassist available for your track. I can play delicately, or be as heavy handed as you need. I consider myself a curator of vintage tone but adore experimenting and pushing beyond what normal bounds of western music has to offer. Clean DI, Vintage amps, Modern HiFi Distortion, Synthish Under Layers. Anything you'd like.

			I can read charts, manuscript, learn by ear. You want steady upright walking bass to vibe up your soul track, mic'd with a CV-12 and D112 through Neve preamps, done. You want punchy, forward sounding big bottom, Stingray through a Radial Clean DI and Ampeg SVTClassic with 8x10 mic'd with a RE20 into an API style pre, done. Classic Motown track, P Bass with flats into a REDDI with a PF-50T through a 1x12 mic'd with a U47 clone into a Neve Pre, yup. Stoner DOOM, EB3 into an Orange Bass Terror with 8x10, Abdominble FUZZ, mic'd with a U47 clone into an API style Pre, it DOOM's. Indy Shoegaze, Jazz Bass, PF-50T with 1x12, EQD afterneath, TC Trem, all through a CV-12 into a Neve, Lets float on a cloud. Any and all combinations, lets make some tone.
		...
		$bio_text4 = "I can play delicately, or be as heavy handed as you need";
		 ...
		 */
		 ...
		 $image_name = '47502269_2021864967859531_4186663240295514112_n.jpg';
		...
		$categories = ['bassist',]; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['Blues','Electronic','Funk','Indie Pop','Jazz','Rock'];  
