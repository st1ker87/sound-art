...
class SinglePersonSeeder52 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_address 	= '1735 W 6th St, Los Angeles, CA 90017';
		$phone 			= '+1 21 3908 7482';
		...
		$bio_text1 = 
			...
			* All features are to be released either anonymously or under my pseudonym SHOOSHI unless stated otherwise.
			
			* Half of payment due upfront. Stems sent upon final payment. 2 basic revisions included. 3-7 day turnaround.
		...
		$bio_text4 = "Over 9 million streams across Youtube, Spotify, & Apple Music";
		...
		$categories = ['Singer','Songwriter','Topliner']; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['EDM','Electronic','Jazz','Pop','R&B','Soul','Rock'];  

		// % OFFERS % 

		$offers = ['recording','writing']; // ! obbligatorio !
