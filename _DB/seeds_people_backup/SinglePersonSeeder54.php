...
class SinglePersonSeeder54 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_address 	= '438 Houston St.160, Nashville, TN 37203';
		$phone 			= '+1 61 5915 1715';
		...
		// * About me
		$bio_text1 = 
			"I am a professional studio/touring bassist & guitarist. I have played on many critically-acclaimed records & look forward to playing on yours! Drake White & The Big Fire, Wade Hayes, Rachel Proctor, Bryan White, O'Shea

			I am currently the bassist/bandleader for Grammy-winning country artist, Kendell Marvel. We tour regularly with Chris Stapleton, Brothers Osborne, Jamey Johnson and play venues from clubs to stadiums around the world.
			
			From 2012-2018, I was the bassist/bandleader for Drake White & The Big Fire. We have toured the world headlining venues in 20+ countries. I was the bassist on Drake's debut album, Spark (Dot Records), as well as the It Feels Good EP and Drake White & The Big Fire (Live).
			
			Drake White & The Big Fire have also toured as direct support for Zac Brown Band, Little Big Town, Dierks Bentley, Randy Houser, Blackberry Smoke, Lynyrd Skynyrd, Toby Keith, Kip Moore and others as well as being featured live on the Today Show and Good Morning America.
			
			Living in Nashville & working with the best studio musicians, artists, engineers, producers & songwriters in the world, I know what it takes to make a record pop from the groove perspective.
			
			Your music deserves to have the best talent available and, in the modern era in which we live, it is completely acheivable. I want to help you execute your musical vision!
			
			Whether you need country, pop, rock, jazz or even a hip hop line, I can lay it down & send you a WAV file that will make your track jump out of the speakers!
		...
		$bio_text4 = "Professional studio/touring bassist & guitarist";
		...
		$categories = ['guitarist','bassist']; // ! obbligatorio !
		
		// % GENRES % 

		$genres = ['Country','Folk','Hip Hop','Latin','Pop','R&B','Soul','Rock'];  
