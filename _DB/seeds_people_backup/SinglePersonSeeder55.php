...
class SinglePersonSeeder55 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_town		= 'Amsterdam, Netherlands';
		$work_address 	= 'Weesperplein 4B, 1018 XA Amsterdam';
		$phone 			= '+31 20 2477 000';
		...
		$bio_text1 = 
			...
			Trumpet player (Trigg & Gusset / Amsterdam Funk Orchestra / Amstel Big Band) all set to spice up your song with a trumpet or flugelhorn solo, a brass top line, muted trumpet or mellow trumpet pads. Experienced in afrobeat, funk, jazz, electronic music, indie pop, rock and singer songwriter.
			...
			Recently I started writing music for my own project 'Call of the Yellow Bird', a kind of afrogroove like music. You can find the website link below to listen. On this track, I play trumpet, guitar, bass and organ, together with some good friends.
		...
		$bio_text4 = "A big warm trumpet sound and catchy melodies is what I'm going for";
		 ...
		 */
		 ...
		 $image_name = 'CoenHamelink_trumpet.jpg';
		...
		$categories = ['trumpeter']; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['Afrobeat','Electronic','Folk','Funk','Jazz','Pop'];  
