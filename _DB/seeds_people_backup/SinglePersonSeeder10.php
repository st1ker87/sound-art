...
class SinglePersonSeeder10 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$bio_text1 = 
			...
			A graduate of the New England Conservatory of Music, Kerry has been writing, composing, and performing piano music for almost three decades. She currently teaches jazz improvisation at Portland State University and the University of Portland.
			
			In addition to providing audio files, Kerry can create piano sheet music and lead sheets.
			
			Kerry has released six albums as a leader, which can be found on all major streaming platforms.
		...
		$bio_text4 = "Classically trained jazz pianist available for a variety of genres";
		...
		$categories = ['pianist','keyboardist']; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['Classical','Folk','Jazz','Latin','Soft Pop'];  
