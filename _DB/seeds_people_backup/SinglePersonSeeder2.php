...
class SinglePersonSeeder2 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_town		= 'Providence, RI, USA';
		$work_address 	= '161 Benefit St, Providence, RI 02903';
		$phone 			= '+14012705269';
		...
		// * About me
		$bio_text1 = 
			"One-woman string section with a specialty in building vocal harmonies and playing Americana-inspired fiddle.
		...
		$bio_text4 = "One-woman string section with a specialty in building vocal harmonies and playing Americana-inspired fiddle.";
		...
		$categories = ['violinist','violist','singer']; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['folk','rock','indie pop','blues','country'];
