...
class SinglePersonSeeder51 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_address 	= '503 S Alvarado St, Los Angeles, CA 90057';
		$phone 			= '+1 21 3413 1811';
		...
		// * About me
		$bio_text1 = 
			"Dreamy vibey vocalist most recently ft. on Wakaan w/ LSDream, Buygore, Proximity & Circus Records. I specialize in all types of EDM. I love working with people who are passionate about their craft. Message me and lets work!

			I specialize in youthful, whimsical, etheral pure vocal tones. With a very clean sound and a unique writing style, I’d love to bring a magical quality to your project! My speciality is singing, writing and recording toplines but I can help support you with background vocals, vocal effects, or vocal production! After several years in the commercial voiceover industry in NYC I moved to Los Angeles to work on a Disney animated musical named Strange Magic. Currently you can hear me singing on Nick Jr, and on PBS in the show Pinkalicous playing \"Fairyanna\". Over my time in LA I’ve had the privilege of being Anna Kendrick’s demo vocalist for the songs in Trolls 1 and 2 and recording demos for the Oscar nominated film LA LA Land for Emma Stones' character.
		...
		$bio_text4 = "I specialize in youthful, whimsical, etheral pure vocal tones";
		 ...
		 */
		 ...
		 $image_name = 'IMG_6036_Facetune_15-01-2020-09-06-54.jpg';
		...
		$categories = ['Vocalist','Singer','Songwriter']; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['EDM','Electric Pop','Electronic','House','Indie Pop','Pop','Trance'];  

		// % OFFERS % 

		$offers = ['recording','arrangement','writing','teaching']; // ! obbligatorio !
