...
class SinglePersonSeeder9 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_address 	= '525 E Broadway, Long Beach, CA 90802';
		$phone 			= '+1 562-612-4951';
		...
		// * About me
		$bio_text1 = 
			"Walt Thompson is a professional musician, mixing engineer, and producer. He has worked on Gold and Platinum selling records and contributes to a music library that is heard on TV, worldwide. Walt is endorsed by Michael Vail Blum at Titan Music. Walt's extensive experience and talent will bring a professional quality to your musical endeavors.

			Walt has over 20 years experience composing, recording, mixing and mastering instrumental tracks for the DL-Music library. Editors from around the world use his work for TV and movies. Shows include: Livin' Large, Early Show, Millionaire Matchmaker, Toddlers and Tiaras, Access Hollywood, RuPaul's Drag Race, Unsung, Full Throttle Saloon, and many others. Networks include: NBC, A&E, MTV, History, Biography, Bravo, and many others.
			Walt has engineered and produced sessions with many artists such as: Albert Lee, Randy Castillo, Jimmy Vivino, Dan Rothchild, Dilana, and Tuesday Knight. He has also performed live and/or in studio sessions with: Better Than Ezra, Beth Hart, Chris Stills Band (featuring Marc Ford), Dilana, rhythm sections from The Goo Goo Dolls and Gov't Mule, Sam Morrison Band, and Billy Vera and the Beaters, just to name a few. For many years, Walt has done freelance work for acclaimed producer, Michael Vail Blum at Titan Music.
			Specializations include great communication and collaboration with the artist to derive exactly what they want to achieve with their music. His extensive knowledge of instrument use and song arrangement makes any song the best it can be. Walt combines modern technology with vintage Neve components to achieve the perfect sound necessary to complete the artist's vision.
		...
		$bio_text4 = "Professional musician, mixing engineer, and producer";
		...
		$categories = ['Keyboardist','Producer','mixer']; // ! obbligatorio ! 
		...
		$offers = ['collaboration','recording','live exhibition']; // ! obbligatorio !
