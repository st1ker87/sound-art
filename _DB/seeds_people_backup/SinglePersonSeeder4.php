...
class SinglePersonSeeder4 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_town		= 'Bucharest, Romania';
		$work_address 	= 'Strada Izvor 2-4';
		...
		$bio_text1 = 
			...
			I'm a Romanian composer and performer and I thrive on the diversity of my projects. I'm classically trained in violin, music education and classical composition. I also pursue music for media.
			
			My main interest is film scoring but I never shied away from trying out different genres of music. Always open to new challenges & experiments, my projects range from classical music to EDM, epic, hybrid, sound design, ambient, world music .
			
			So far, I've been writing for Really Slow Motion, Digic Pictures, The Library Of Human Soul, Silva Screen, CrimeSonics and when I'm not writing music, I'm also collaborating with other composers as a session violinist & vocalist.
			
			In 2017, I have been picked as one of the 5 finalists to perform the Hanging Tree song in Vienna, during James Newton Howard’s European tour.
			
			In 2018 I released my first EP as a singer/songwriter, worked on 3 RPG games and also recorded 3 virtual libraries for Big Fish Audio as a violinist & vocalist.
			
			People tend to hire me for my diversity, my vast experience in various fields of music - performing, composing, conducting - and for my excellent human relationships.
			I'm an emotive & eclectic artist who always brings that into her projects.
			
			If that's what your project needs, feel free to let me know how can I help, through the 'Contact' button above.";
		...
		$bio_text4 = "Musical story-telling and emotions provider for your project!";
		...
		$categories = ['composer','violinist','singer']; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['Chill','Choral','Classical']; 

		// % OFFERS % 

		$offers = ['live exhibition','collaboration','recording','teaching']; // ! obbligatorio !
