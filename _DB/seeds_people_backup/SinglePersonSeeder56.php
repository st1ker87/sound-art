...
class SinglePersonSeeder56 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$work_town		= 'Miami, FL USA';
		$work_address 	= '1050 NW 14th St, Miami, FL 33136';
		$phone 			= '+1 30 5428 3710';
		...
		// * About me
		$bio_text1 = 
			"Groovy & Rhythmic. 7-time Rhythm of Gospel Award Nominee. Seasoned from the Caribbean to the US & Beyond!
			...
			Invite someone to sponsor your recording project, then message me here in soundbetter. I'll help you with the music! Copy + paste or send the following link to your prospective sponsor: https://soundbetter.com/gift-certificate
		...
		$bio_text4 = "7-time Rhythm of Gospel Award Nominee";
		 ...
		 */
		 ...
		 $image_name = 'KDT_Instruments_1.jpg';
		...
		$categories = ['Bassist','Guitarist']; // ! obbligatorio !
		
		// % GENRES % 

		$genres = ['Gospel','Soundtrack'];  
