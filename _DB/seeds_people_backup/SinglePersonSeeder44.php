...
class SinglePersonSeeder44 extends Seeder
{
    /**
	...
	// #  MINIMAL EDIT START                                                                                            
		...
		$name 		= 'Brenda Dor-Groot';
		$surname 	= 'Dor-Groot';

		// % PROFILE % 

		$work_town		= 'London, UK';
		$work_address 	= '6 Portland Rd, London W11 4LA';
		$phone 			= '+44 20 7229 3130';
		...
		$bio_text1 = 
			...
			Can deliver home studio tracks, or come to studios in/near London and Amsterdam depending on dates.
			High quality instruments including Salvi Aurora concert grand pedal harp, Killarney superb Irish folk harp, and Camac solid body electric lever harp w. effect pedals (whammy, wah, octaver, distortion and more).
			
			I can either play from your written parts or demo recording exactly, or improvise or properly arrange my part from a chord chart or any recording.
		...
		$bio_text4 = "Acoustic & electric harpist";
		 ...
		 */
		 ...
		 $image_name = 'Brenda_Camac_stagepic_blue_crop.jpg';
		...
		$categories = ['Harpist']; // ! obbligatorio ! 
		
		// % GENRES % 

		$genres = ['Blues','Classical','EDM','House','Jazz','Techno'];  

		// % OFFERS % 

		$offers = ['recording','collaboration']; // ! obbligatorio !
